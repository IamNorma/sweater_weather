...
RSpec.describe 'Weather Facade' do
  it 'returns weather based on location' do
    ...
    expect(weather.current_weather.feels_like).to be_a(String)
    ...
    expect(weather.daily_weather.first.max_temp).to be_a(String)
    expect(weather.daily_weather.first.min_temp).to be_a(String)
